...
import '../data/interactor/defaul_recipe_interactor.dart' as _i6;
...
import '../ui/home_store.dart' as _i7; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i3.RecipeService>(() => _i4.HttpRecipeService());
